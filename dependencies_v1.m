...
%column indicating if GDP is dependent on that variable
    ...
    T('Agriculture', 'Tertiary') = depends_on(agriculture, tertiary, threshold);
    T('Agriculture', 'GDP') = depends_on(gdp, agriculture, threshold);
    T('Industry', 'Tertiary') = depends_on(industry, tertiary, threshold);
    T('Industry', 'GDP') = depends_on(gdp, industry, threshold);
    T('Government', 'Tertiary') = depends_on(government, tertiary, threshold);
    T('Government', 'GDP') = depends_on(gdp, government, threshold);
    T('Articles', 'Tertiary') = depends_on(articles, tertiary, threshold);
